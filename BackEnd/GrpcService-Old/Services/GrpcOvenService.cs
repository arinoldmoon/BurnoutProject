...
namespace GrpcService.Services
{
    public class GrpcOvenService : OvenProto.OvenProtoBase
    {
        ...
        public GrpcOvenService(ILogger<GrpcOvenService> logger, IOvenDbService dbService, IOvenPlcService plcService, IOptions<PLCConfig> config)
        {
            _logger = logger;
        ...
        public override async Task<ProtoOvenSetting> GetOvenSetting(Empty request, ServerCallContext context)
        {
            ...
            response = await _plcService.GetOvenSetting();
