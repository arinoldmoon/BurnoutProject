...
class HomePageSizes {
  // Home Page Menu
  static const homePageMenuPadding =
      EdgeInsets.symmetric(vertical: 15, horizontal: 10);
  static const homePageMenuSpacing = EdgeInsets.symmetric(horizontal: 18);
  ...
  static const double homePageMachineCardHieght = 150.0;
